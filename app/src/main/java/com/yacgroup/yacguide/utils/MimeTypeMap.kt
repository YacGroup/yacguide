...
/*
 * Normally this function is provided by library android.webkit.MimeTypeMap.
 ...
 */
enum class MimeTypeMap(val mimeType: String) {
    eJSON("application/json"),
    eCVS("text/comma-separated-values");
    ...
    companion object {
        ...
        init {
            values().forEach {
                _extension_by_mimeType[it.mimeType] = it.name.removePrefix("e").lowercase()
            }
        }
