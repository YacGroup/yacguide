...
class UpdateHandler(private val _activity: AppCompatActivity,
    ...
    init {
        ...
        _updateDialog = Dialog(_activity).apply {
            ...
            _updateDialogBinding = InfoDialogBinding.inflate(it.layoutInflater).apply {
                cancelButton.setOnClickListener { abort()  }
            }
            it.setContentView(_updateDialogBinding.root)
        }
    }
